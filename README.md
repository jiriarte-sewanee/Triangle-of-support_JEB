...
**IMPORTANT:** Each of these scripts require some data that needs to be calculated beforehand. 
Also, the code assumes that all the needed files are in the current MATLAB folder.
...
**NOTE 2** The code needs several functions from the geometry processing library MatGeom
