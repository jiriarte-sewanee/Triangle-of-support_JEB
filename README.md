...
> Each of these scripts requires some data that needs to be calculated beforehand. 
...
* The 'ToS_gapeEffect' script requires to load the 'normalized_LTcurve.mat' file
...
* The main scripts rely heavily on functions from the geometry processing library **matGeom**. You can download the library from https://github.com/mattools/matGeom/.

* To run the 'calculateMuscleMoment' script, we need the 'intersectPlaneSurf'
...
* The function 'directionalRayTriangleIntersect' calls the mex function
